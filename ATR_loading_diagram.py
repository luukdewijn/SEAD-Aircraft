...
#CG VALUES
OEW = ... #operating empty weight [N] FIND THESE
...
battery_mass= ... #battery mass [kg] FIND THESE

fuel_cg_wing = ... * l_f #fuel cg location in wing FIND THESE
fuel_cg_center = ... #fuel cg location in center (=location of propulsion group) FIND THESE

battery_mass_cg = ... #removable battery cg FIND THESE
